...
import { GitPullRequest, Presentation, Tags, Users } from "lucide-react";
...
const navs: NavigationCardProps[] = [
  ...
  },
  {
    ...
    icon: <Tags />,
    title: "Category",
    description: "Click here to manage categories for courses",
  },
  {
    to: "/admin/user-management",
    icon: <Users />,
    title: "User Management",
    description: "Click here to manage users, teachers and admins",
  },
  {
    to: "/admin/request",
    icon: <GitPullRequest />,
    title: "Requests",
    description: "Click here to view and manage requests",
  },
];
