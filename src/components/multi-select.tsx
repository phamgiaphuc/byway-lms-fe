...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const getAllOptions = React.useCallback((): MultiSelectOption[] => {
      ...
      if (import.meta.env.MODE === "development" && duplicates.length > 0) {
    ...
    const getOptionByValue = React.useCallback(
      (value: string): MultiSelectOption | undefined => {
        ...
        if (!option && import.meta.env.MODE === "development") {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="-m-0.5 mb-0.5 ml-2 h-4 w-4 cursor-pointer rounded-sm p-0.5 hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none"
                            >
                              <XCircle
                                className={cn(
                                  "h-3 w-3",
